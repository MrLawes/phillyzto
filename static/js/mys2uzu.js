...
window.Typekit.config = {
    ...
    "dl": "AAAA2AAAAAqeNdWmwZaYeazjBHSoxMGLT6sye71fWnwAJa0_",
    "fi": [173, 175, 5474, 10294, 10296, 10302],
    "fc": [{
        "id": 173,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/153d6b/0000000000000000000148a6/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {"weight": "600", "style": "normal", "subset_id": 2}
    }, {
        "id": 175,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/f794fc/0000000000000000000148a4/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {"weight": "400", "style": "normal", "subset_id": 2}
    }, {
        "id": 5474,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/611614/0000000000000000000148a2/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {"weight": "300", "style": "normal", "subset_id": 2}
    }, {
        "id": 10294,
        "family": "brandon-grotesque",
        "src": "https://use.typekit.net/af/dc695b/0000000000000000000132df/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {"weight": "400", "style": "normal", "subset_id": 2}
    }, {
        "id": 10296,
        "family": "brandon-grotesque",
        "src": "https://use.typekit.net/af/b54b90/0000000000000000000132e3/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {"weight": "700", "style": "normal", "subset_id": 2}
    }, {
        "id": 10302,
        "family": "brandon-grotesque",
        "src": "https://use.typekit.net/af/e9e0e2/0000000000000000000132e1/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {"weight": "500", "style": "normal", "subset_id": 2}
    }],
    "fn": ["brandon-grotesque", ["n4", "n5", "n7"], "proxima-nova", ["n3", "n4", "n6"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.18.23",
    "kt": "mys2uzu",
...
(function (window, document, undefined) {
    ...
    function da() {
        var a = [{name: "font-family", value: n.c[q + 1]}];
        this.g = [n.c[q]];
        this.b = a
    }
    ...
    fa.prototype.has = function (a) {
        ...
        for (var b = "number" === typeof a, c = 0; c < this.i; c++) {
            var d;
            if (b)d = r(a & 4294967295, 3432918353), d = d << 15 | d >>> 17, d = r(d, 461845907), d ^= ga[c] || 0, d = d << 13 | d >>> 19, d = r(d, 5) + 3864292196, d ^= 4, d ^= d >>> 16, d = r(d, 2246822507), d ^= d >>> 13, d = r(d, 3266489909), d ^= d >>> 16, d = (d >>> 0) % this.b; else {
                d = ga[c] || 0;
                var e, f, g = a.length % 4, h = a.length - g;
    ...
    function C(a) {
        if (a.i) {
            var b = ja(a.g, a.b.b("wf", "active")), c = [], d = [a.b.b("wf", "loading")];
    ...
    function D(a, b, c) {
        if (a.o && a.j[b])try {
            if (c)a.j[b](c.b, E(c)); else a.j[b]()
        } catch (d) {
            console.error('Typekit: Error in "' + b + '" callback', d)
        }
        if (a.m[b])if (c)a.m[b](c.b, E(c)); else a.m[b]()
    };
    function la(a, b, c) {
        c = c || {};
        this.b = a;
    ...
    function G(a, b) {
        return new la(b, a.g, {weight: a.weight, style: a.style, B: a.B, C: a.C})
    }
    ...
    var P = {K: "serif", J: "sans-serif"}, Q = null;
    ...
    za.prototype.start = function () {
        var a = this.m.g.document, b = this, c = m(), d = new Promise(function (d, e) {
            function h() {
        ...
        if (!e && c)C(a.b); else {
            ...
            K(b, function (b) {
                ...
                if (null === T)if (window.FontFace) {
                    var e = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent), p = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent);
    ...
    S.prototype.j = function (a) {
        var b = this.b;
        if (b.i) {
            var c = ja(b.g, b.b.b("wf", a.b, E(a), "active")), d = [], e = [b.b.b("wf", a.b, E(a), "loading")];
    ...
    U.prototype.load = function (a, b, c) {
        ...
        a = c.timeout;
        var e = !!c.async, f = ma(), g = oa(this.o, f);
        c = new B(this.b, c, {
            active: function () {
                if (e) {
                    var a = L(g, f, d.i, !1);
                ...
                if (d.m) {
                    var a = d.m, b = d.b, c = a.m, h = (window.__adobewebfontsappname__ || a.app || "").toString().substr(0, 20), b = b.g.location.hostname || b.i.location.hostname,
                        l = [], w = [];
                    ...
                    for (var x = 0; x < a.b.length; x++) {
                        for (var pa = !1, Z = 0; Z < w.length; Z++)if (a.b[x] === w[Z]) {
                            pa = !0;
                            break
                        }
    ...
    function Ga() {
        var a = n.ps, b = n.ht, c = n.fi, d = n.a, e = n.kt, f = n.js, g = n.l;
        this.m = new H(n.ping);
        this.j = a;
        this.i = b;
        this.b = c || [];
    ...
    W = new U(Ha);
    n.ping && (W.m = new Ga);
    if (n.fc)for (var X = n.fc, Y = 0; Y < X.length; Y++)W.o.b.push(new la(X[Y].family, X[Y].src, X[Y].descriptors));
    if (n.dl) {
        var Ia = n.dl;
        try {
            W.j = new ha(Ia)
        ...
        window.Typekit.load = function (a) {
            ...
            a.fontactive = function (a, b) {
                ...
                a:{
                    ...
                    h += "00";
                    for (var l = n.fc, p = 0; p < l.length; p++)if (l[p].family === a && l[p].descriptors.weight === h && l[p].descriptors.style === g) {
                        g = l[p].id;
                        break a
                    }
                    g = 0
