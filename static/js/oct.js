twttr = window.twttr || {}, twttr.conversion = function () {
    function e(e, t) {
        var n = !1, i = !0, r = e.document, o = r.documentElement, a = r.addEventListener, s = a ? "addEventListener" : "attachEvent", u = a ? "removeEventListener" : "detachEvent", c = a ? "" : "on", d = function (i) {
    ...
    var n = "&tpx_cb=twttr.conversion.loadPixels", i = "//t.co/i/adsct?p_id=Twitter&p_user_id=0", r = "https://analytics.twitter.com/i/adsct?p_id=Twitter&p_user_id=0", o = function (e, t) {
        var n = t.toLowerCase();
        for (var i in e)if (i.toLowerCase() === n && e.hasOwnProperty(i))return !0;
        return !1
    }, a = function (e, t) {
        var n = t.toLowerCase();
        for (var i in e)if (i.toLowerCase() === n && e.hasOwnProperty(i))return e[i]
    };
    return t.prototype = {
        setPixelId: function (e) {
            ...
            var t = {}, n = this.isObject(e[0]) ? e[0] : {}, i = this.isObject(n[1]) ? n[1] : {};
        ...
        if (window.twq) {
            var e = new t;
            twq.exe = function () {
                var t, n = Array.prototype.slice.call(arguments), i = n[0], r = n.slice(1);
                switch (i) {
                    case"init":
                        t = e.setPixelId;
                        break;
        ...
        trackPidBase: function (e, t, i, r) {
            if (t) {
                ...
                var s = e + "&txn_id=" + encodeURIComponent(t) + o, u = this.getIframeStatus();
        ...
        buildPixelWhenVizChange: function (e, t, n) {
            var i = t.replace(/[H|h]idden/, "") + "visibilitychange", r = function () {
        ...
        IframeStatusCodes: {NOT_IN_IFRAME: {value: 0}, IN_IFRAME: {value: 1}, ERROR: {value: 2}},
