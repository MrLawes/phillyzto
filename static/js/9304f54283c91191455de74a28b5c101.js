...
(function (b, k) {
    ...
    function c(d, a) {
        ...
        a = a.criteria;
        if (d !== a) {
            if (d > a || "undefined" == typeof d)return 1;
    ...
    function g() {
        for (var a = {
            ...
            top: "",
            useHas: !0
        }, b, g = 0; b = arguments[g]; g++)for (var c in b)a[c] = b[c];
        b = a.args;
        a.firstArg = /^[^,]+/.exec(b)[0];
        g = Function;
    ...
    function D(a, b, g, c, f, l) {
        ...
        if (!c || !b)return c && !n ? w ? p(e) : na({}, e) : e;
        c = U[h];
        switch (h) {
            case "[object Boolean]":
            case "[object Date]":
    ...
    function K(a, b, g) {
        ...
        if (!G(a))return a;
        if (g === fa)var l = c[3], n = c[4], h = c[5]; else n = [], h = [], "number" != typeof g && (e = c.length), 3 < e && "function" == typeof c[e - 2] ? l = d(c[--e - 1], c[e--], 2) : 2 < e && "function" == typeof c[e - 1] && (l = c[--e]);
    ...
    var ua = "object" == typeof exports && exports, va = "object" == typeof module && module && module.exports == ua && module, wa = "object" == typeof global && global;
    wa.global === wa && (b = wa);
    var O = [], ia = {}, Ra = 0,
        fa = ia, Sa = b._, Ta = /&(?:amp|lt|gt|quot|#39);/g, Ua = /\b__p \+= '';/g, Va = /\b(__p \+=) '' \+/g, Wa = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Pa = /\w*$/, ja = RegExp("^" + (ia.valueOf + "").replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$"), Xa = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, Ha = /<%=([\s\S]+?)%>/g, ka = /($^)/, Ya = /[&<>"']/g, Za = /['\n\r\t\u2028\u2029\\]/g, $a = 0, ab = Math.ceil, ea = O.concat, Ia = Math.floor, ga = ja.test(ga = Object.getPrototypeOf) && ga, H = ia.hasOwnProperty, ha = O.push, L = ia.toString, X = ja.test(X = p.bind) &&
            X, xa = ja.test(xa = Array.isArray) && xa, bb = b.isFinite, cb = b.isNaN, ba = ja.test(ba = Object.keys) && ba, V = Math.max, qa = Math.min, Ja = Math.random, Ka = !!b.attachEvent, ya = X && !/\n|true/.test(X + Ka), Qa = X && !ya, Ma = ba && (Ka || ya), Q = {"[object Function]": !1};
    ...
    var Ba = {"boolean": !1, "function": !0, object: !0, number: !1, string: !1, undefined: !1}, Na = {
        "\\": "\\",
        "'": "'",
        "\n": "n",
        "\r": "r",
    ...
    var za = {
            ...
            arrays: !1
        }, N = g(la), Z = g(la, La, {useHas: !1}), aa = g(la, La), I = xa || function (a) {
                return a instanceof
    ...
    a.invoke = function (a, d) {
        var b = p(arguments, 2), g = -1, c = "function" == typeof d, f = a ? a.length : 0, e = Array("number" == typeof f ? f : 0);
        J(a, function (a) {
...
(function (b) {
    ...
    a.util.domain = function (a) {
        return (-1 === document.location.host.indexOf("bitly") ? "" : "") + a
    };
    ...
    a.util.hashToQueryString = function (a, b, c) {
        var f = [];
        for (key in a)for (var e = $.isArray(a[key]) ? a[key] : [a[key]], h = 0, k = e.length; h < k; h++)"?" === e[h] && c ? f.push(encodeURIComponent(key) + "=" + e[h]) : f.push(encodeURIComponent(key) + "=" + encodeURIComponent(e[h]));
        a = f.length ? "?" + f.join("&") : "";
        return (b || "") + a
    };
    ...
    a.util.relativeTime = function (a, b) {
        ...
        b = b || {};
        var f = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), e = new Date(1E3 * a), h = new Date, k = h - e, q = "", y = e.getFullYear();
        h.getFullYear();
        h = new Date;
        h.setHours(0);
        h.setMinutes(0);
    ...
    a.util.timeAgoInWords = function (a, b) {
        ...
        var c = b - a, f = Math.floor(c / 6E4), e = Math.floor(c / 36E5), h = Math.floor(c / 864E5), c = Math.floor(c / 31536E6), k = "ago";
    ...
    a.util.scrollTo = function (a) {
        ...
        a = a || {};
        var c = a.dur || 150, f = a.end || 0, e = a.scroll_el || document.body, h = a.onfinish, B = a.dist, q, y, C = $.Deferred();
    ...
    var e = "(?:(https?|ftp|itms)://)?", h = "(?:(?:[^\\s\\!\"\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\.\\/\\:\\;\\<\\=\\>\\?\\@\\\\[\\]\\^\\_`\\{\\|\\}\\~]+\\.)+(?:aero|arpa|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|local|example|invalid|test|\u0645\u0635\u0631|\u0440\u0444|\u0627\u0644\u0633\u0639\u0648\u062f\u064a\u0629|\u0627\u0645\u0627\u0631\u0627\u062a|xn--wgbh1c|xn--p1ai|xn--mgberp4a5d4ar|xn--mgbaam7a8h|\u4e2d\u56fd|\u4e2d\u570b|\u9999\u6e2f|\u0627\u0644\u0627\u0631\u062f\u0646|\u0641\u0644\u0633\u0637\u064a\u0646|\u0642\u0637\u0631|\u0dbd\u0d82\u0d9a\u0dcf|\u0b87\u0bb2\u0b99\u0bcd\u0b95\u0bc8|\u53f0\u7063|\u53f0\u6e7e|\u0e44\u0e17\u0e22|\u062a\u0648\u0646\u0633|xn--fiqs8S|xn--fiqz9S|xn--j6w193g|xn--mgbayh7gpa|xn--ygbi2ammx|xn--wgbl6a|xn--fzc2c9e2c|xn--xkc2al3hye2a|xn--kpry57d|xn--kprw13d|xn--o3cw4h|xn--pgbs0dh|\u0625\u062e\u062a\u0628\u0627\u0631|\u0622\u0632\u0645\u0627\u06cc\u0634\u06cc|\u6d4b\u8bd5|\u6e2c\u8a66|\u0438\u0441\u043f\u044b\u0442\u0430\u043d\u0438\u0435|\u092a\u0930\u0940\u0915\u094d\u0937\u093e|\u03b4\u03bf\u03ba\u03b9\u03bc\u03ae|\ud14c\uc2a4\ud2b8|\u05d8\u05e2\u05e1\u05d8|\u30c6\u30b9\u30c8|\u0baa\u0bb0\u0bbf\u0b9f\u0bcd\u0b9a\u0bc8|xn--kgbechtv|xn--hgbk6aj7f53bba|xn--0zwm56d|xn--g6w251d|xn--80akhbyknj4f|xn--11b5bs3a9aj6g|xn--jxalpdlp|xn--9t4b11yi5a|xn--deba0ad|xn--zckzah|xn--hlcj6aya9esc7a|[a-z]{2})(?::[0-9]+)?|(?:[0-9]{1,3}\\.){3}(?:[0-9]{1,3}))",
...
(function (b) {
    ...
    var a, e = null, h = "0.0.0", c = null, f = null, d = null, g = {}, l = 0, m = {}, u = 0, p = {}, B = null, q = null, y = function () {
    ...
    x.prototype.on = function (a, b) {
        ...
        if ("string" === typeof a && a)l = a.toLowerCase().split(/\s+/); else if ("object" === typeof a && a && "undefined" === typeof b)for (g in a)if (a.hasOwnProperty(g) && "string" === typeof g && g && "function" === typeof a[g])this.on(g, a[g]);
        if (l && l.length) {
            g = 0;
    ...
    var S = function (c, e) {
        ...
        if ((l = m[this.id] && m[this.id].handlers[c]) && l.length) {
            var C, n, t = p || this;
            y = 0;
            for (C = l.length; y < C; y++)n = l[y], p = t, "string" === typeof n && "function" === typeof b[n] && (n = b[n]), "object" === typeof n && n && "function" === typeof n.handleEvent && (p = n, n = n.handleEvent), "function" === typeof n && G(n, p, q, u)
        }
        return this
    };
...
(function () {
    var b;
    b = function (b) {
        return -1 === document.location.hostname.indexOf("bitly") ? "" + b : b
...
function rstr2b64(b) {
    ...
    for (var a = "", e = b.length, h = 0; h < e; h += 3)for (var c = b.charCodeAt(h) << 16 | (h + 1 < e ? b.charCodeAt(h + 1) << 8 : 0) | (h + 2 < e ? b.charCodeAt(h + 2) : 0), f = 0; 4 > f; f++)a = 8 * h + 6 * f > 8 * b.length ? a + b64pad : a + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(c >>> 6 * (3 - f) & 63);
    return a
}
...
(function (b, k, a) {
        ...
        resize: function () {
            try {
                var a = {
                    left: 0,
                    top: 0
                }, b = this.isBody ? this.$root.width() : this.$root.innerWidth(), c = b, d = this.isBody ? k.innerHeight ? k.innerHeight : this.$root.height() : this.$root.innerHeight(), f = c / this.$img.data("ratio"), e;
    ...
    var f, d = navigator.userAgent,
        g = navigator.platform, l = d.match(/AppleWebKit\/([0-9]+)/), l = !!l && l[1], m = d.match(/Fennec\/([0-9]+)/), m = !!m && m[1], u = d.match(/Opera Mobi\/([0-9]+)/), p = !!u && u[1], B = d.match(/MSIE ([0-9]+)/), B = !!B && B[1];
    ...
    function a(a) {
        ...
        this.setValue = function (a) {
            a != h && setTimeout(function () {
                var b = c.find(".page-home-link-shortener-counter-number-card-from"), e = c.find(".page-home-link-shortener-counter-number-card-to:not(.n)");
    ...
    b.fn.ajaxSubmit = function (a) {
        function e() {
            ...
            if (b(":input[name=submit],:input[id=submit]", e).length)alert('Error: Form elements must not have name or id of "submit".');
                ...
                var u = b('<iframe id="' + h + '" name="' + h + '" src="' + g.iframeSrc + '" onload="window[\'_\'+this.id]()" />'), z = u[0];
